...
//                break;
    ...
    private static String handleUSEDGrammer(String endpoint){
        ...
        if (endpoint.contains("ing ") || endpoint.contains("ship") || endpoint.contains("tion")) endpoint = "for " + endpoint; //Ex: "used for writing", "used for companionship", "used for hydration"
